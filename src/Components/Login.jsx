...
const Login = () => {
  return (
    <div className="flex w-full xsm:h-screen">
      ...
      <div className="xsm:w-full md:m-20 mb-0 xsm:p-5 md:w-[70%] flex flex-col items-center  ">
        <div className="w-full">
          <img
            src={backArrow}
            className=" cursor-pointer md:w-[42px] md:h-[30px]"
          />
        </div>
        ...
        <div className="my-4 ">
          <span className="suggest-des">
            ...
            <Link to="/" className="link-action ms-2">
              Sign Up
            </Link>
          </span>
        </div>
